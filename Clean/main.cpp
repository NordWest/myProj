...
*/
    ...
    for(i=0; i<tlen; i++)
    {
        ...
        fk = tFunc(tk)+(rand()/(RAND_MAX*1.0))-1.0;
...
//		cout << "W[2J]= " << W[2*Jey].mod() << endl;
                ...
                C[Jey_m-m].setRe(C[Jey_m-m].Re() + g*a.Re());
                C[Jey_m-m].setIm(C[Jey_m-m].Im() + g*a.Im());
