...
public:
	...
	long detNaxes(long *naxes0=NULL, long *naxes1=NULL);	//define maximum marks resolution
        ...
        void sortMagn(int direction=0);					//СЃРѕСЂС‚РёСЂРѕРІРєР° РїРѕ Р·РІРµР·РґРЅРѕР№ РІРµР»РёС‡РёРЅРµ (marks[]->mEkv[2])
                                                                        //direction - РЅР°РїСЂР°РІР»РµРЅРёРµ СЃРѕСЂС‚РёСЂРѕРІРєРё
                                                                        //0 - РѕС‚ РјРµРЅСЊС€РµР№ Рє Р±РѕР»СЊС€РµР№ (СЃРЅР°С‡Р°Р»Р° СЏСЂРєРёРµ)
        void sortAper(int direction=0);					//СЃРѕСЂС‚РёСЂРѕРІР°С‚СЊ РїРѕ РїРёРєСЃРµР»СЊРЅРѕР№ СЏСЂРєРѕСЃС‚Рё (marks[]->mTanImg[2])
                                                                        //direction - РЅР°РїСЂР°РІР»РµРЅРёРµ СЃРѕСЂС‚РёСЂРѕРІРєРё,
                                                                        //0 - РѕС‚ РјРµРЅСЊС€РµР№ Рє Р±РѕР»СЊС€РµР№ (СЃРЅР°С‡Р°Р»Р° СЃР»Р°Р±С‹Рµ)
