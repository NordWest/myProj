...
/*
        ...
        double Dpixmag;         //[]
*/
        //double ra_oc, dec_oc;		//йННПДХМЮ� Ш НО� ХВЕЯЙНЦН ЖЕМ� ПЮ
        //QString obsCode;
        double topDist;                 //[au]
...
/*
    ...
    x                   ХГЛЕПЕММЮЪ ЙННПДХМЮ� Ю X [pix]
    y                   ХГЛЕПЕММЮЪ ЙННПДХМЮ� Ю Y [pix]
    pixmag              ОХЙЯЕКЭМЮЪ ГБ. БЕКХВХМЮ
    Dx,Dy, Dpixmag      НЬХАЙХ ХГЛЕПЕММШУ ЙННПДХМЮ�  [pix]
    topDist             � НОНЖЕМ� ПХВЕЯЙНЕ ПЮЯЯ� НЪМХЕ [AU]
    muRaCosDec          БХДХЛЮЪ СЦКНБЮЪ ЯЙНПНЯ� Э ЮЯ� ЕПНХДЮ ОН Ra * cosDe [mas/min]
    muDe                БХДХЛЮЪ СЦКНБЮЪ ЯЙНПНЯ� Э ЮЯ� ЕПНХДЮ ОН De [mas/min]
    Vr                  КСВЕБЮЪ ЯЙНПНЯ� Э ЮЯ� ЕПНХДЮ [km/s]
    phase               ТЮГЮ ЮЯ� ЕПНХДЮ [deg]
    elong               ЩКНМЦЮЖХЪ [deg]
    expTime             ДКХ� ЕКЭМНЯ� Э ЩЙЯОНГХЖХХ [sec]
    name                ХЛЪ НАЗЕЙ� Ю
    catName             ХЛЪ ЙЮ� ЮКНЦЮ
    catMagName          ХЛЪ ГБ БЕКХВХМШ Б ЙЮ� ЮКНЦЕ
...
public:
	...
	void s2rec(QString str);
        ...
        int vflag;      //МЮКХВХЕ ЙНКНМНЙ Я ЩТЕЛЕПХДМШЛХ ГМЮВЕМХЪЛХ ЯЙНПНЯ� Х ДБХФЕМХЪ НАЗЕЙ� Ю.
        int ndig;
};
...
public:
	...
	int ndig, nfrac;
        //ndig - ВХЯКН ГМЮВЮЫХУ ЖХТП Б БШБНДХЛНЛ ПЕГСКЭ� Ю� Е.
        //nfrac - ВХЯКН ГМЮВЮЫХУ ЖХТП ОНЯКЕ ГЮОЪ� НИ Б БШБНДХЛНЛ ПЕГСКЭ� Ю� Е.
        //vflag - МЮКХВХЕ ЙНКНМНЙ Я ЩТЕЛЕПХДМШЛХ ГМЮВЕМХЪЛХ ЯЙНПНЯ� Х ДБХФЕМХЪ НАЗЕЙ� Ю.
	...
	void sortColList();
        ...
        int countCols(QString colNums);        //ЯДЕКЮ� Э НЯПЕДМЕМХЕ ОН Я� НКАЖЮЛ ocList Я МНЛЕПЮЛХ, ГЮДЮММШЛХ Б Я� ПНЙЕ colNums (ПЮГДЕКХ� ЕКЭ - ',')
        int reCountCols();                     //ОЕПЕДЕКЮ� Э НЯПЕДМЕМХЕ ОН Я� НКАЖЮЛ ocList МЮ НЯМНБЕ СФЕ ЯСЫЕЯ� БСЧЫХУ colList
        void do3sigma(double proofP, double sigmaMul, QList <ocRec*> *rejList = NULL);                        //ЯДЕКЮ� Э Н� АПЮЙНБЙС ОН 3*sigma ДКЪ OMC(ra) Х OMC(dec)
...
public:
    ...
    int countCols(QList <colRec*> *colList, QString colNums);        //ЯДЕКЮ� Э НЯПЕДМЕМХЕ ОН Я� НКАЖЮЛ ocList Я МНЛЕПЮЛХ, ГЮДЮММШЛХ Б Я� ПНЙЕ colNums (ПЮГДЕКХ� ЕКЭ - ',')
...
public:
    ...
    int countCols(QString colNums);        //ЯДЕКЮ� Э НЯПЕДМЕМХЕ ОН Я� НКАЖЮЛ ocList Я МНЛЕПЮЛХ, ГЮДЮММШЛХ Б Я� ПНЙЕ colNums (ПЮГДЕКХ� ЕКЭ - ',')
    int reCountCols();                     //ОЕПЕДЕКЮ� Э НЯПЕДМЕМХЕ ОН Я� НКАЖЮЛ ocList МЮ НЯМНБЕ СФЕ ЯСЫЕЯ� БСЧЫХУ colList
    void do3sigma(double proofP, double sigmaMul);                        //ЯДЕКЮ� Э Н� АПЮЙНБЙС ОН 3*sigma ДКЪ OMC(ra) Х OMC(dec)
    int countMM(int fp = 0, int ft = 0, int vflag = 1);
    void delMMrec();
