 ...
 // extern int nofzbody;
  ...
  double dist(double X0[], double X1[])
  {
    ...
    void Everhardt::force(double X[], double V[], double TS, double F[])
    {
        ...
        int pla[10] = {
                SUN_NUM, MERCURY_NUM, VENUS_NUM, GEOCENTR_NUM, MARS_NUM, JUPITER_NUM, SATURN_NUM, URANUS_NUM, NEPTUNE_NUM, PLUTO_NUM
        };
...
//		    cout << "WARN!!!! V OUT!!!!" << endl;
    ...
    //				cout << "WARN!!!! CRASH!!!!" << endl;
                     ...
                     res0 += pow(mass[teloj], -1.0)*((Xj[j+komp] - X[i+komp])/(pow(Dij,3)));
