...
//
	...
	int get(unsigned short *x, int *pos, int *sizes = NULL);
	int get(short *x, int *pos, int *sizes = NULL);
	int get(long *x, int *pos, int *sizes = NULL);
	...
	void set(unsigned short *fdata, int len = 0);
	void set(short *fdata, int len = 0);
	void set(long *fdata, int len = 0);
	void set(float *fdata, int len = 0);
	void set(double *fdata, int len = 0);
	
	void set(unsigned short *fdata, int* pos, int *sizes = NULL);	//взять элемент 
	void set(short *fdata, int* pos, int *sizes = NULL);
	void set(long *fdata, int* pos, int *sizes = NULL);
	void set(float *fdata, int* pos, int *sizes = NULL);
	void set(double *fdata, int* pos, int *sizes = NULL);
