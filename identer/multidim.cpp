...
///////////////////////////////
void multidim::set(unsigned short *fdata, int* pos, int *sizes)
{
	if(bpix!=USHORT_IMG) return;
//	if(len>size) return;
//	if(len==0) len = size;
...
void multidim::set(short *fdata, int* pos, int *sizes)
{
	if(bpix!=SHORT_IMG) return;
//	if(len>size) return;
//	if(len==0) len = size;
...
void multidim::set(long *fdata, int* pos, int *sizes)
{
	if(bpix!=LONG_IMG) return;
//	if(len>size) return;
//	if(len==0) len = size;
...
void multidim::set(float *fdata, int* pos, int *sizes)
{
	if(bpix!=FLOAT_IMG) return;
//	if(len>size) return;
//	if(len==0) len = size;
...
void multidim::set(double *fdata, int* pos, int *sizes)
{
	if(bpix!=DOUBLE_IMG) return;
//	if(len>size) return;
//	if(len==0) len = size;
