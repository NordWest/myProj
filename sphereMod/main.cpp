...
int main(int argc, char *argv[])
{
    ...
    raMin = sett->value("general/raMin").toDouble()*3600000*15.0;
    raMax = sett->value("general/raMax").toDouble()*3600000*15.0;
    deMin = sett->value("general/deMin").toDouble()*3600000.0;
    deMax = sett->value("general/deMax").toDouble()*3600000.0;
    int pointNum = sett->value("general/pointNum").toInt();

    double *Eps = new double[3];
    Eps[0] = sett->value("rotation/ex").toDouble();
    Eps[1] = sett->value("rotation/ey").toDouble();
    Eps[2] = sett->value("rotation/ez").toDouble();

    double epsi = grad2rad(sett->value("general/eps").toDouble());
    int csys = sett->value("general/coord_sys").toInt();

    double disp = sett->value("noice/disp").toDouble();
