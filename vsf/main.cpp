...
int main(int argc, char *argv[])
{
    ...
    stream <<"Tl_n x Tl_m +Tb_n x Tb_m = "<<QString("%1").arg(I[0],10,'f',3,QLatin1Char( '0' )) <<endl;
    stream <<"Sl_n x Sl_m +Sb_n x Sb_m = "<<QString("%1").arg(I[1],10,'f',3,QLatin1Char( '0' )) <<endl;
    stream <<"Tl_n x Sl_m +Tb_n x Sb_m = "<<QString("%1").arg(I[2],10,'f',3,QLatin1Char( '0' )) <<endl;
    stream <<"Sl_n x Tl_m +Sb_n x Tb_m = "<<QString("%1").arg(I[3],10,'f',3,QLatin1Char( '0' )) <<endl;
