...
int main(int argc, char *argv[])    //ruler3PL.exe file.wcs [options] [config=cfg.ini] [plName=10000] [headerFile=./header.txt] [resFolder=./results]
    {  
        ...
        QString cfgFileName = "reAver.ini";
